...
public class PGNetConnection implements PGConnection {
    private static final Logger LOGGER = Logger.get(PGNetConnection.class);
    ...
    public PGNetConnection(String ip) throws IOException {
        this(ip, DEFAULT_PORT);
    }
    public PGNetConnection(String ip, int port) throws IOException {
